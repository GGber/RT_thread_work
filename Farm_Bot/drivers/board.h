...
/*-------------------------- PIN_DEFINE --------------------------*/
#define ADDR1 GET_PIN(A,11)
#define ADDR2 GET_PIN(A,8)
#define ADDR3 GET_PIN(A,7)
#define ADDR4 GET_PIN(A,6)
#define ADDR5 GET_PIN(A,5)
#define ADDR6 GET_PIN(A,4)
#define ADDR7 GET_PIN(A,1)
#define ADDR8 GET_PIN(A,0)

#define IIC_SCL GET_PIN(B,6)
#define IIC_SDA GET_PIN(B,7)
/*-------------------------- UART CONFIG BEGIN --------------------------*/
...
#define MODBUS_SLAVE_PORT_NUM               3
